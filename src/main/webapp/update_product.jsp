...
<body>
	...
	int pid = Integer.parseInt(request.getParameter("pid"));
		...
		Product product = productController.getProductsByProductId(pid);
	%>
				...
				<div class="card">
					...
					<form action="AddOperationServlet?pid=<%=pid%>" method="post"
						...
						<div class="card-body">
							...
							<div class="mb-3">
								<label class="form-label"><b>Uploaded Image:&nbsp;</b></label><%=product.getImages()%>
								&emsp;<img src="Product_imgs\<%=product.getImages()%>"
									style="width: 80px; height: 80px; width: auto;"> <input
									type="hidden" name="image"
									value="<%=product.getImages()%>">
							</div>
						</div>
