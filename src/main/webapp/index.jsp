...
<body>
		...
		<div class="row">
			<div class="card-group">
				...
				<div class="col text-center">
					<a href="products.jsp?category=<%=c.getCategory_Id()%>"
						style="text-decoration: none;">
						<div class="card cus-card h-100">
							<div class="container text-center">
								<img src="Product_imgs\<%=c.getImage()%>" class="mt-3 "
	...
	<div id="carouselAutoplaying"
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="Images/Imgae.png" class="d-block w-100" alt="...">
			</div>
	...
	<div class="container-fluid py-3 px-3" style="background: #f2f2f2;">
		<div class="row row-cols-1 row-cols-md-4 g-3">
			...
			%>
			<div class="col">
				<a href="viewProduct.jsp?pid=<%=productList.get(i).getProduct_Id()%>"
					style="text-decoration: none;">
					<div class="card h-100">
						<div class="container text-center">
							<img
								src="Product_imgs\<%=productList.get(i).getImages()%>"
						...
						<div class="card-body">
							...
							<div class="container text-center">
								...
								&ensp;<span class="product-price">&#8377;<%=productList.get(i).getPrice()%>
								</span>&ensp;<span class="product-discount"><%=productList.get(i).getDiscount()%>&#37;
									off</span>
							</div>
						</div>
					</div>
	...
	<div class="container-fluid py-3 px-3" style="background: #f0fffe;">
		...
		<div class="row row-cols-1 row-cols-md-4 g-3">
			...
			%>
			<div class="col">
				<a href="viewProduct.jsp?pid=<%=topDeals.get(i).getProduct_Id()%>"
					style="text-decoration: none;">
					<div class="card h-100">
						<div class="container text-center">
							<img src="Product_imgs\<%=topDeals.get(i).getImages()%>"
								class="card-img-top m-2"
								style="max-width: 100%; max-height: 200px; width: auto;">
						</div>
						<div class="card-body">
							<h5 class="card-title text-center"><%=topDeals.get(i).getName()%></h5>

							<div class="container text-center">
								<span class="real-price">&#8377;<%=topDeals.get(i).getProductPriceAfterDiscount()%></span>
								&ensp;<span class="product-price">&#8377;<%=topDeals.get(i).getPrice()%>
								</span>&ensp;<span class="product-discount"><%=topDeals.get(i).getDiscount()%>&#37;
									off</span>
							</div>
						</div>
					</div>
