				...
				<div class="card">
					<div class="container px-3 py-3">
						...
						if (from.trim().equals("cart")) {
															...
															int totalProduct = cartDao.getCartCountByUserId(user.getUser_Id());
						...
						<%
											...
											float price = productDao.getProductPriceById(product_id);
						%>
						<table class="table table-borderless">
							<tr>
								<td>Total Item</td>
			...
			<div class="modal-content">
				...
				<form action="UpdateUserServlet" method="post">
					...
					<div class="modal-body mx-3">
						...
						<div class="mt-2">
							<label class="form-label fw-bold">Postal Code</label> <input
