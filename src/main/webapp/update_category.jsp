...
<body>
	...
	Category category = categoryController.getCategoryById(cid);
	%>
						...
						<div class="card-body">
							...
							<div class="mb-3">
								<label class="form-label"><b>Category Name</b></label> <input
									type="text" name="category_name" value="<%=category.getName()%>" class="form-control" >
							</div>
							<div class="mb-3">
							...
							<div class="mb-3">
								<label class="form-label"><b>Uploaded Image:&nbsp;</b></label><%=category.getImage()%>&emsp;<img
									src="Product_imgs\<%=category.getImage()%>"
									style="width: 80px; height: 80px; width: auto;">
								<input type="hidden" name="image" value="<%=category.getImage()%>">
							</div>
						</div>
